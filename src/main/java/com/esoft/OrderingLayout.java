...
public class OrderingLayout extends VerticalLayout implements I18NComponent,
		I18NListener {
	...
	public OrderingLayout() {
		I18N i18n = new ResourceBundleI18N(Constants.RESOURCE_BUNDLE_BASE_NAME_ORDERING, Constants.LIST_SUPPORTED_LOCALE);
